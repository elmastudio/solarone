...
<div class="wp-block-ainoblocks-multiple-buttons"><!-- wp:ainoblocks/button {"size":"size__l","borderRadius":10,"label":"Get Started"} -->
<div class="wp-block-ainoblocks-button" style="border-radius:10px"><a class="wp-block-ainoblocks-button__link size__l 10" style="border-radius:10px"><?php echo esc_html__('Get Started', 'soloarone'); ?></a></div>
