 ...
 * Slug: solarone/footer-soloarone-default
 * Categories: footer
 * Block Types: core/template-part/footer
 */
?>

<!-- wp:group {"backgroundColor":"background-primary","className":"site-footer","style":{"spacing":{"padding":{"left":"var:preset|spacing|9","right":"var:preset|spacing|9"}}}} -->
<div class="wp-block-group site-footer has-background-primary-background-color has-background" style="padding-right:var(--wp--preset--spacing--9);padding-left:var(--wp--preset--spacing--9)"><!-- wp:group {"className":"footer-content content-gap","paddingTop":13,"paddingBottom":12} -->
...
<div class="wp-block-group"><!-- wp:heading {"level":4,"textColor":"font-primary","fontSize":"text-xs","paddingBottom":8} -->
...
<!-- wp:social-links {"iconColor":"font-primary","iconColorValue":"#000000","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|4","left":"var:preset|spacing|4"}}},"className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"left"}} -->
...
<div class="wp-block-ainoblocks-flex-item auto"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs","paddingTop":0,"paddingBottom":5,"paddingRight":8} -->
...
<!-- wp:ainoblocks/flex-item -->
<div class="wp-block-ainoblocks-flex-item auto"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs","paddingTop":0,"paddingBottom":5,"paddingLeft":0,"paddingRight":8} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size pb__5 pr__8"><a href="#"><?php echo esc_html__('Privacy Policy', 'soloarone'); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/flex-item -->

<!-- wp:ainoblocks/flex-item -->
<div class="wp-block-ainoblocks-flex-item auto"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs","paddingTop":0,"paddingBottom":5,"paddingLeft":0,"paddingRight":0} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size pb__5"><a href="#"><?php echo esc_html__('Imprint', 'soloarone'); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/flex-item --></div>
<!-- /wp:ainoblocks/flexbox --></div>
