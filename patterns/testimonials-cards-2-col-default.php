...
<img class="wp-block-ainoblocks-profile-image has-quinary-background-color has-background" style="width:calc(40px + 2px * 2);padding:2px;border-radius:100%" src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/avatar-img-small.jpeg'; ?>" alt=""/>
...
<img class="wp-block-ainoblocks-profile-image has-quarternary-background-color has-background" style="width:calc(40px + 2px * 2);padding:2px;border-radius:100%" src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/avatar-img-small.jpeg'; ?>" alt=""/>
