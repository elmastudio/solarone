...
<p class="has-text-align-center has-tertiary-color has-text-color has-text-xxs-font-size pt__1" style="font-style:normal;font-weight:700;text-transform:uppercase;letter-spacing:2px"><?php echo esc_html__('Recent Highlights', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
