...
<div class="wp-block-ainoblocks-grid-item col_start_d__4 col_end_d__10 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking"><!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700","letterSpacing":"2px"}},"textColor":"accent-primary","fontSize":"text-xxs","paddingTop":1} -->
<p class="has-text-align-center has-accent-primary-color has-text-color has-text-xxs-font-size pt__1" style="font-style:normal;font-weight:700;text-transform:uppercase;letter-spacing:2px"><?php echo esc_html__('Recent Highlights', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:post-featured-image {"isLink":true,"className":"br-all__xs"} /-->

<!-- wp:post-terms {"term":"category","textColor":"font-secondary","fontSize":"text-xs"} /-->

<!-- wp:post-title {"level":3,"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","lineHeight":"1.1"}},"textColor":"font-primary","fontSize":"text-xxl"} /-->
