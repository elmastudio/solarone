...
<div class="wp-block-group alignfull has-variant-background-primary-background-color has-background pt__18 pb__18"><!-- wp:ainoblocks/grid-container {"className":"alignwide col-gap-l"} -->
...
<div class="wp-block-ainoblocks-grid-item col_start_d__4 col_end_d__10 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 justify-self__stretch no-stacking mt_t__0 mt_m__8 align-self__start"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700","textTransform":"uppercase","letterSpacing":"2px"}},"textColor":"variant-accent-primary","fontSize":"text-xxs","paddingTop":1} -->
<p class="has-text-align-center has-variant-accent-primary-color has-text-color has-text-xxs-font-size pt__1" style="font-style:normal;font-weight:700;letter-spacing:2px;text-transform:uppercase">We are here to help you</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","textColor":"variant-font-primary","fontSize":"text-xxxl","paddingTop":5} -->
<h2 class="has-text-align-center has-variant-font-primary-color has-text-color has-text-xxxl-font-size pt__5">Frequently asked questions</h2>
<!-- /wp:heading --></div>
<!-- /wp:ainoblocks/grid-item -->

<!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":5,"gridColumnEndDesktop":9,"gridColumnStartTablet":3,"gridColumnEndTablet":11,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"justifyItem":"stretch","marginTopTablet":0,"marginTopMobile":8,"className":"align-self__start","borderRadius":"none"} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__5 col_end_d__9 col_start_t__3 col_end_t__11 col_start_m__1 col_end_m__13 justify-self__stretch no-stacking mt_t__0 mt_m__8 align-self__start br-all__none"><!-- wp:paragraph {"align":"center","textColor":"variant-font-secondary","fontSize":"text-m","paddingTop":8,"paddingBottom":10} -->
<p class="has-text-align-center has-variant-font-secondary-color has-text-color has-text-m-font-size pt__8 pb__10">Find the answers you are looking for by browsing through a number of questions we get asked a lot.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->

<!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":3,"gridColumnEndDesktop":11,"gridColumnStartTablet":1,"gridColumnEndTablet":13,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"justifyItem":"stretch","marginTopTablet":0,"marginTopMobile":8,"className":"align-self__start","borderRadius":"none"} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__3 col_end_d__11 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 justify-self__stretch no-stacking mt_t__0 mt_m__8 align-self__start br-all__none"><!-- wp:ainoblocks/accordion-faq-block {"backgroundColor":"variant-background-secondary","borderRadius":"xs","iconPosition":"icon__left","question":"What do you think is the best way to keep learning when you are running a business?","style":{"border":{"width":"1px"}},"borderColor":"variant-border-secondary","textColor":"variant-font-secondary","className":"br__xs","paddingTop":7,"paddingBottom":7,"paddingLeft":7,"paddingRight":7} -->
