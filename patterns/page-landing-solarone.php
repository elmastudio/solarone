...
<div class="wp-block-ainoblocks-flex-item auto"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-m","paddingRight":13,"paddingTop":1} -->
<p class="has-font-secondary-color has-text-color has-text-m-font-size pr__13 pt__1"><?php echo esc_html__('We help you reach new markets and stand out from the competition.', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/solarone-hero-01.png'; ?>" alt="Full Site Editing Block WordPress Theme"/></figure>
<!-- /wp:image --></div>
...
<div class="wp-block-ainoblocks-flexbox direction__row__d direction__row__t direction__row__m nowrap__d nowrap_t nowrap_m justify__flexstart__d justify__flexstart__t justify__flexstart__m align-items__center__d align-items__center__t align-items__center__m align-cont__stretch__d align-cont__stretch__t align-cont__stretch__m shadow-none"><!-- wp:ainoblocks/flex-item {"flexShrink":true} -->
<div class="wp-block-ainoblocks-flex-item auto" style="flex-shrink:0"><!-- wp:image {"width":64,"height":64,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/icon-circle-02.png'; ?>" alt="" width="64" height="64"/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/flex-item -->
...
<figure class="wp-block-image size-full" style="border-radius:10px"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/videoframe.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/brand-01-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/brand-02-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/brand-03-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/brand-04-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/brand-05-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item --></div>
<!-- /wp:ainoblocks/grid-container --></div>
<!-- /wp:group -->

<!-- wp:pattern {"slug":"solarone/features-text-left-img-right-default"} /-->

<!-- wp:pattern {"slug":"solarone/features-img-left-text-right-default"} /-->
...
<h2 class="has-font-primary-color has-text-color has-text-xxl-font-size pt__5"><?php echo esc_html__('Technology can help you grow and thrive', 'soloarone'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-m","paddingTop":3,"paddingRight":0} -->
<p class="has-font-secondary-color has-text-color has-text-m-font-size pt__3"><?php echo esc_html__('With our proprietary technology and the best designers in the business, we craft smart solutions for our clients that use their data to drive better business.', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-style-default"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/solarone-featured-03.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item --></div>
<!-- /wp:ainoblocks/grid-container --></div>
<!-- /wp:group -->

<!-- wp:pattern {"slug":"solarone/features-wide-default"} /-->
