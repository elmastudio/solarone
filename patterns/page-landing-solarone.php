...
<figure class="wp-block-image size-full"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/solarone-hero-01.png'; ?>" alt="Full Site Editing Block WordPress Theme"/></figure>
<!-- /wp:image --></div>
...
<div class="wp-block-ainoblocks-flexbox direction__row__d direction__row__t direction__row__m nowrap__d nowrap_t nowrap_m justify__flexstart__d justify__flexstart__t justify__flexstart__m align-items__center__d align-items__center__t align-items__center__m align-cont__stretch__d align-cont__stretch__t align-cont__stretch__m shadow-none"><!-- wp:ainoblocks/flex-item {"flexShrink":true} -->
<div class="wp-block-ainoblocks-flex-item auto" style="flex-shrink:0"><!-- wp:image {"width":64,"height":64,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/icon-circle-02.png'; ?>" alt="" width="64" height="64"/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/flex-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/brand-01-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/brand-02-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/brand-03-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/brand-04-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/brand-05-default.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item --></div>
<!-- /wp:ainoblocks/grid-container --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full is-style-default"><img src="<?php echo SOLARONE_THEME_DIR . '/assets/images/solarone-featured-03.png'; ?>" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:ainoblocks/grid-item --></div>
<!-- /wp:ainoblocks/grid-container --></div>
<!-- /wp:group -->
