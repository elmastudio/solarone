...
<div class="wp-block-ainoblocks-flex-item auto"><!-- wp:heading {"textColor":"font-primary","className":"test","fontSize":"text-4-xl"} -->
<h2 class="test has-font-primary-color has-text-color has-text-4-xl-font-size"><?php echo esc_html__('Deliver amazing digital experiences.', 'soloarone'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-m","paddingTop":5,"paddingBottom":6} -->
<p class="has-font-secondary-color has-text-color has-text-m-font-size pt__5 pb__6"><?php echo esc_html__('We\'ve helped thousands of companies, just like yours, change their businesses.', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
