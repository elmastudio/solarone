...
<div class="wp-block-ainoblocks-grid-item col_start_d__4 col_end_d__10 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mt_t__0 mt_m__8 br-all__none"><!-- wp:heading {"textAlign":"center","textColor":"font-primary","fontSize":"text-5-xl","paddingTop":0} -->
...
<!-- wp:paragraph {"align":"center","textColor":"font-secondary","paddingTop":5} -->
<p class="has-text-align-center has-font-secondary-color has-text-color pt__5">We are a small team of digital marketing experts supporting your businesses growth. Let's connect and let us help you grow.</p>
<!-- /wp:paragraph --></div>
...
<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-m","paddingTop":7} -->
<p class="has-font-secondary-color has-text-color has-text-m-font-size pt__7">Monthly</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textColor":"font-primary","fontSize":"text-4-xl","paddingTop":0} -->
<h2 class="has-font-primary-color has-text-color has-text-4-xl-font-size">Free</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs","paddingTop":7,"paddingBottom":7} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size pt__7 pb__7">This is a description for the pricing tier.</p>
<!-- /wp:paragraph -->
...
<!-- wp:ainoblocks/flexbox {"alignItemsDesktop":"align-items__center__d","alignContentDesktop":"align-cont__flexstart__d","paddingTop":5} -->
<div class="wp-block-ainoblocks-flexbox direction__row__d direction__row__t direction__row__m nowrap__d nowrap_t nowrap_m justify__flexstart__d justify__flexstart__t justify__flexstart__m align-items__center__d align-items__stretch__t align-itms__stretch__m align-cont__flexstart__d align-cont__stretch__t align-cont__stretch__m shadow-none pt__5"><!-- wp:ainoblocks/flex-item -->
<div class="wp-block-ainoblocks-flex-item auto"><!-- wp:ainoblocks/icon {"iconType":"checkcircle","iconSize":"size-s"} -->
<div class="wp-block-ainoblocks-icon checkcircle size-s"><svg width="25px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16.643 10.293c0.3-0.286 0.311-0.761 0.025-1.060s-0.761-0.311-1.060-0.025l-4.985 4.756-2.229-2.13c-0.299-0.286-0.774-0.275-1.060 0.024s-0.275 0.774 0.024 1.060l2.747 2.625c0.29 0.277 0.746 0.277 1.036 0l5.503-5.25z"></path><path d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75c5.385 0 9.75-4.365 9.75-9.75s-4.365-9.75-9.75-9.75zM3.75 12c0-4.556 3.694-8.25 8.25-8.25s8.25 3.694 8.25 8.25c0 4.556-3.694 8.25-8.25 8.25s-8.25-3.694-8.25-8.25z"></path></svg></div>
<!-- /wp:ainoblocks/icon --></div>
<!-- /wp:ainoblocks/flex-item -->
...
<!-- wp:heading {"textColor":"font-primary","fontSize":"text-4-xl","paddingTop":0} -->
<h2 class="has-font-primary-color has-text-color has-text-4-xl-font-size">$69</h2>
<!-- /wp:heading -->
...
<h3 class="has-font-primary-color has-text-color has-text-l-font-size">Pro</h3>
<!-- /wp:heading --></div>
<!-- /wp:ainoblocks/flex-item -->
...
<!-- wp:heading {"textColor":"font-primary","fontSize":"text-4-xl","paddingTop":0} -->
<h2 class="has-font-primary-color has-text-color has-text-4-xl-font-size">$149</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"textColor":"font-primary","fontSize":"text-4-xl","paddingTop":0} -->
<h2 class="has-font-primary-color has-text-color has-text-4-xl-font-size">$299</h2>
<!-- /wp:heading -->
...
<div class="wp-block-ainoblocks-grid-item col_start_d__4 col_end_d__10 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mt_t__0 mt_m__8 br-all__none"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700","textTransform":"uppercase","letterSpacing":"2px"}},"textColor":"variant-tertiary","fontSize":"text-xxs"} -->
<p class="has-text-align-center has-variant-tertiary-color has-text-color has-text-xxs-font-size" style="font-style:normal;font-weight:700;text-transform:uppercase;letter-spacing:2px"><?php echo esc_html__('We are here to help you', 'soloarone'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","textColor":"variant-font-primary","fontSize":"text-xxxl","paddingTop":5} -->
<h2 class="has-text-align-center has-variant-font-primary-color has-text-color has-text-xxxl-font-size pt__5"><?php echo esc_html__('Frequently asked questions', 'soloarone'); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:ainoblocks/grid-item -->

<!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":5,"gridColumnEndDesktop":9,"gridColumnStartTablet":3,"gridColumnEndTablet":11,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"justifyItem":"stretch","marginTopTablet":0,"marginTopMobile":8,"borderRadius":"none"} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__5 col_end_d__9 col_start_t__3 col_end_t__11 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mt_t__0 mt_m__8 br-all__none"><!-- wp:paragraph {"align":"center","textColor":"variant-font-secondary","fontSize":"text-m","paddingTop":8,"paddingBottom":10} -->
<p class="has-text-align-center has-variant-font-secondary-color has-text-color has-text-m-font-size pt__8 pb__10"><?php echo esc_html__('Find the answers you are looking for by browsing through a number of questions we get asked a lot.', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<div class="wp-block-ainoblocks-grid-item col_start_d__5 col_end_d__9 col_start_t__3 col_end_t__11 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mt_t__0 mt_m__8"><!-- wp:paragraph {"align":"center","textColor":"font-secondary","fontSize":"text-m","paddingTop":8,"paddingBottom":0} -->
<p class="has-text-align-center has-font-secondary-color has-text-color has-text-m-font-size pt__8"><?php echo esc_html__('It\'s always the best source to hear from others who have already worked with us.', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->

<!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":2,"gridColumnEndDesktop":12,"gridColumnStartTablet":1,"gridColumnEndTablet":13,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"justifyItem":"stretch","marginTopTablet":0,"marginTopMobile":8} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking mt_t__0 mt_m__8"></div>
<!-- /wp:ainoblocks/grid-item --></div>
<!-- /wp:ainoblocks/grid-container -->

<!-- wp:ainoblocks/grid-container {"className":"alignwide col-gap-l","paddingTop":13} -->
<div class="wp-block-ainoblocks-grid-container alignwide ab-grid-block col-gap-l pt__13"><!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":2,"gridColumnEndDesktop":12,"gridColumnStartTablet":1,"gridColumnEndTablet":13,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"alignItem":"stretch","justifyItem":"stretch","borderRadius":"none"} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__12 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__stretch justify-self__stretch no-stacking br-all__none"><!-- wp:ainoblocks/testimonial {"style":"indent-l","paddingBottom":0} -->
<div class="wp-block-ainoblocks-testimonial indent-l"><!-- wp:ainoblocks/card {"backgroundColor":"background-primary","borderRadius":"l","paddingTop":11,"paddingBottom":11,"paddingLeft":13,"paddingRight":13,"className":"relative"} -->
<div class="wp-block-ainoblocks-card shadow-none pt__11 pb__11 pl__13 pr__13 relative has-background-primary-background-color has-background br-all__l"><!-- wp:ainoblocks/icon {"iconType":"quote","iconSize":"size-l","textColor":"font-secondary"} -->
...
<!-- wp:ainoblocks/flexbox {"flexDirectionMobile":"direction__col__m"} -->
<div class="wp-block-ainoblocks-flexbox direction__row__d direction__row__t direction__col__m nowrap__d nowrap_t nowrap_m justify__flexstart__d justify__flexstart__t justify__flexstart__m align-items__stretch__d align-items__stretch__t align-itms__stretch__m align-cont__stretch__d align-cont__stretch__t align-cont__stretch__m shadow-none"><!-- wp:ainoblocks/flex-item {"paddingLeft":7,"paddingRight":7} -->
<div class="wp-block-ainoblocks-flex-item auto pl__7 pr__7"><!-- wp:paragraph {"placeholder":"Write testimonial text...","style":{"color":{}},"textColor":"font-secondary","fontSize":"text-l","paddingTop":8,"paddingBottom":8,"paddingLeft":0,"paddingRight":0} -->
<p class="has-font-secondary-color has-text-color has-text-l-font-size pt__8 pb__8"><?php echo esc_html__('Get to know our passionate team of digital marketing experts.', 'soloarone'); ?><?php echo esc_html__('SolarOne is your one-stop shop for all your digital marketing and web design needs. We do it all from SEO to Website Design and Development, Social Media Management, PPC, Display Ads, Video Production, as well as Desktop and Mobile App Development.', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/flex-item -->
...
<img class="wp-block-ainoblocks-profile-image img-l has-quinary-background-color has-background" style="width:calc(144px + 6px * 2);padding:6px;border-radius:100%" src="<?php echo get_template_directory_uri(); ?>/assets/images/avatar-img-large.jpeg" alt=""/>
