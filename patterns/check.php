...
<h1 class="has-font-primary-color has-text-color has-text-5-xl-font-size pb__13">Our Journey so far</h1>
<!-- /wp:heading --></div>
...
<p class="has-font-secondary-color has-text-color has-text-l-font-size">We are a creative content and design agency for startups and small businesses. We elevate brands with captivating content and engaging, beautiful design - turning visions into realities.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textColor":"font-primary","fontSize":"text-l","paddingTop":12} -->
<h2 class="has-font-primary-color has-text-color has-text-l-font-size pt__12">In the numbers</h2>
<!-- /wp:heading -->
...
<p class="has-font-primary-color has-text-color has-text-6-xl-font-size pt__9" style="font-style:normal;font-weight:600;letter-spacing:-2px">48+</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"has-font-secondary-color has-text-color has-text-xs-font-size"} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size">Creative team members and contractors.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"-2px"}},"textColor":"font-primary","fontSize":"text-6-xl","paddingTop":9} -->
<p class="has-font-primary-color has-text-color has-text-6-xl-font-size pt__9" style="font-style:normal;font-weight:600;letter-spacing:-2px">62%</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"has-font-secondary-color has-text-color has-text-xs-font-size"} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size">Revenue on average for our clients.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"-2px"}},"textColor":"font-primary","fontSize":"text-6-xl","paddingTop":9} -->
<p class="has-font-primary-color has-text-color has-text-6-xl-font-size pt__9" style="font-style:normal;font-weight:600;letter-spacing:-2px">78,958</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs"} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size">Total orders of our marketing App addons.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<figure class="wp-block-image size-full is-style-default br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/solarone-about.jpeg" alt="SolarOne WordPress FSE Block Theme" class="wp-image-22319"/></figure>
<!-- /wp:image --></div>
...
<p class="has-text-align-center has-variant-tertiary-color has-text-color has-text-xl-font-size" style="font-style:normal;font-weight:700">Meet the team</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/team-01-variant.png" alt=""/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/team-02-variant.png" alt=""/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/team-03-variant.png" alt=""/></figure>
<!-- /wp:image -->
...
<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__5 col_start_t__1 col_end_t__5 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking pb__13"><!-- wp:image {"sizeSlug":"full","borderRadius":"l"} -->
<figure class="wp-block-image size-full br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/team-04-variant.png" alt=""/></figure>
<!-- /wp:image -->
...
<!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":5,"gridColumnEndDesktop":9,"gridColumnStartTablet":5,"gridColumnEndTablet":9,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"paddingBottom":13} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__5 col_end_d__9 col_start_t__5 col_end_t__9 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking pb__13"><!-- wp:image {"sizeSlug":"full","borderRadius":"l"} -->
<figure class="wp-block-image size-full br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/team-05-variant.png" alt=""/></figure>
<!-- /wp:image -->
...
<!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":9,"gridColumnEndDesktop":13,"gridColumnStartTablet":9,"gridColumnEndTablet":13,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"paddingBottom":13} -->
<div class="wp-block-ainoblocks-grid-item col_start_d__9 col_end_d__13 col_start_t__9 col_end_t__13 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking pb__13"><!-- wp:image {"sizeSlug":"full","borderRadius":"l"} -->
<figure class="wp-block-image size-full br-all__l"><img src="http://ainodev.local/wp-content/themes/solarone/assets/images/team-06-variant.png" alt=""/></figure>
<!-- /wp:image -->
