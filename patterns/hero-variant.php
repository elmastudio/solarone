...
<div class="wp-block-ainoblocks-multiple-buttons"><div class="wp-block-ainoblocks-multiple-buttons__inner"><!-- wp:ainoblocks/button {"size":"size__l","borderRadius":10,"label":"Get Started","backgroundColor":"variant-primary","textColor":"variant-button-color-primary"} -->
<div class="wp-block-ainoblocks-button has-variant-button-color-primary-color has-variant-primary-background-color has-text-color has-background" style="border-radius:10px"><a class="wp-block-ainoblocks-button__link size__l 10" style="border-radius:10px"><?php echo esc_html__('Get Started', 'soloarone'); ?></a></div>
