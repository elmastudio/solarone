<?php
/**
 * Title: Two-column featured posts (default)
 * Slug: solarone/featured-posts2-col-default
 * Categories: query
 */
?>
...
<div class="wp-block-ainoblocks-grid-item col_start_d__4 col_end_d__10 col_start_t__2 col_end_t__12 col_start_m__1 col_end_m__13 align-self__start justify-self__stretch no-stacking"><!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700","letterSpacing":"2px"}},"textColor":"tertiary","fontSize":"text-xxs"} -->
<p class="has-text-align-center has-tertiary-color has-text-color has-text-xxs-font-size" style="font-style:normal;font-weight:700;text-transform:uppercase;letter-spacing:2px"><?php echo esc_html__('Recent Highlights', 'soloarone'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","textColor":"font-primary","fontSize":"text-xxxl","paddingTop":5} -->
<h2 class="has-text-align-center has-font-primary-color has-text-color has-text-xxxl-font-size pt__5"><?php echo esc_html__('Learn more about marketing in our featured blog entries', 'soloarone'); ?></h2>
<!-- /wp:heading --></div>
...
<!-- wp:post-terms {"term":"category","textColor":"font-secondary","fontSize":"text-xs"} /-->

<!-- wp:post-title {"level":3,"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","lineHeight":"1"}},"textColor":"font-primary","fontSize":"text-xxl","fontFamily":"libre-franklin"} /-->

<!-- wp:post-excerpt {"showMoreOnNewLine":false,"textColor":"font-secondary","fontSize":"text-xs"} /-->
