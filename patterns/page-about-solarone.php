...
<div class="wp-block-ainoblocks-grid-container alignwide ab-grid-block col-gap-l"><!-- wp:ainoblocks/grid-item {"gridColumnStartDesktop":2,"gridColumnEndDesktop":12,"gridColumnStartTablet":1,"gridColumnEndTablet":13,"gridColumnStartMobile":1,"gridColumnEndMobile":13,"marginTopTablet":0,"marginTopMobile":8,"borderRadius":"none"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-l"} -->
<p class="has-font-secondary-color has-text-color has-text-l-font-size"><?php echo esc_html__('We are a creative content and design agency for startups and small businesses. We elevate brands with captivating content and engaging, beautiful design - turning visions into realities.', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"className":"has-font-secondary-color has-text-color has-text-xs-font-size"} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size"><?php echo esc_html__('Creative team members and contractors.', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"className":"has-font-secondary-color has-text-color has-text-xs-font-size"} -->
<p class="has-font-secondary-color has-text-color has-text-xs-font-size"><?php echo esc_html__('Revenue on average for our clients.', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-font-secondary-color has-text-color has-text-xs-font-size"><?php echo esc_html__('Total orders of our marketing App addons.', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<div class="wp-block-ainoblocks-grid-item col_start_d__2 col_end_d__7 col_start_t__1 col_end_t__6 col_start_m__1 col_end_m__13 align-self__start justify-self__start no-stacking mt_t__0 mt_m__8 br-all__none"><!-- wp:image {"id":22319,"linkDestination":"none","className":"size-full is-style-default","borderRadius":"l"} -->
...
<h3 class="has-variant-font-primary-color has-text-color has-text-l-font-size pt__7"><?php echo esc_html__('Amila Williams', 'soloarone'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":5} -->
<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__5"><?php echo esc_html__('Co-founder', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<!-- wp:heading {"level":3,"textColor":"variant-font-primary","fontSize":"text-l","paddingTop":7} -->
<h3 class="has-variant-font-primary-color has-text-color has-text-l-font-size pt__7"><?php echo esc_html__('Jo Khan', 'soloarone'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":5} -->
<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__5"><?php echo esc_html__('Brand Strategist', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<!-- wp:heading {"level":3,"textColor":"variant-font-primary","fontSize":"text-l","paddingTop":7} -->
<h3 class="has-variant-font-primary-color has-text-color has-text-l-font-size pt__7"><?php echo esc_html__('Bert Mejia', 'soloarone'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":5} -->
<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__5"><?php echo esc_html__('Project Manager', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<!-- wp:heading {"level":3,"textColor":"variant-font-primary","fontSize":"text-l","paddingTop":7} -->
<h3 class="has-variant-font-primary-color has-text-color has-text-l-font-size pt__7"><?php echo esc_html__('Maggie Patel', 'soloarone'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":5} -->
<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__5"><?php echo esc_html__('Software Developer', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<!-- wp:heading {"level":3,"textColor":"variant-font-primary","fontSize":"text-l","paddingTop":7} -->
<h3 class="has-variant-font-primary-color has-text-color has-text-l-font-size pt__7"><?php echo esc_html__('Robert Palmer', 'soloarone'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":5} -->
<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__5"><?php echo esc_html__('Analyst', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item -->
...
<!-- wp:heading {"level":3,"textColor":"variant-font-primary","fontSize":"text-l","paddingTop":7} -->
<h3 class="has-variant-font-primary-color has-text-color has-text-l-font-size pt__7"><?php echo esc_html__('Liz Rossi', 'soloarone'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"variant-font-secondary","fontSize":"text-xs","paddingTop":5} -->
<p class="has-variant-font-secondary-color has-text-color has-text-xs-font-size pt__5"><?php echo esc_html__('Creative Manager', 'soloarone'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:ainoblocks/grid-item --></div>
<!-- /wp:ainoblocks/grid-container --></div>
<!-- /wp:ainoblocks/grid-item --></div>
