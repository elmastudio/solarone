 ...
 * Slug: solarone/header-solarone-default
 * Categories: header
 * Block Types: core/template-part/header
 */
?>

<!-- wp:group {"style":{"spacing":{"padding":{"left":"var:preset|spacing|9","right":"var:preset|spacing|9"}}},"className":"site-header"} -->
<div class="wp-block-group site-header" style="padding-right:var(--wp--preset--spacing--9);padding-left:var(--wp--preset--spacing--9)"><!-- wp:group {"className":"header-content tablet-flex justify-between","layout":{"type":"default"},"paddingTop":8,"paddingBottom":8} -->
...
<!-- wp:ainoblocks/flexbox {"justifyContentDesktop":"justify__flexend__d","justifyContentTablet":"justify__flexend__t","justifyContentMobile":"justify__flexend__m","alignItemsTablet":"align-items__center__t","alignItemsMobile":"align-items__center__m","alignContentTablet":"align-cont__flexend__t","alignContentMobile":"align-cont__flexend__m","className":"mobile-hide tablet-show"} -->
<div class="wp-block-ainoblocks-flexbox direction__row__d direction__row__t direction__row__m nowrap__d nowrap_t nowrap_m justify__flexend__d justify__flexend__t justify__flexend__m align-items__stretch__d align-items__center__t align-items__center__m align-cont__stretch__d align-cont__flexend__t align-cont__flexend__m shadow-none mobile-hide tablet-show"><!-- wp:ainoblocks/flex-item {"paddingLeft":2} -->
<div class="wp-block-ainoblocks-flex-item auto pl__2"><!-- wp:ainoblocks/multiple-buttons -->
<div class="wp-block-ainoblocks-multiple-buttons"><!-- wp:ainoblocks/button {"size":"size__xs","borderRadius":6,"label":"Sign In","className":"is-style-outline"} -->
<div class="wp-block-ainoblocks-button is-style-outline" style="border-radius:6px"><a class="wp-block-ainoblocks-button__link size__xs 6" style="border-radius:6px">Sign In</a></div>
<!-- /wp:ainoblocks/button -->

<!-- wp:ainoblocks/button {"size":"size__xs","borderRadius":6,"label":"Get started","style":{"spacing":{"margin":{"left":"1rem"}}}} -->
<div class="wp-block-ainoblocks-button" style="margin-left:1rem;border-radius:6px"><a class="wp-block-ainoblocks-button__link size__xs 6" style="border-radius:6px">Get started</a></div>
