...
<p class="has-tertiary-color has-text-color has-text-xxs-font-size" style="font-style:normal;font-weight:700;text-transform:uppercase;letter-spacing:2px"><?php echo esc_html__('We help you shine', 'soloarone'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textColor":"font-primary","fontSize":"text-xxl","paddingTop":5} -->
<h2 class="has-font-primary-color has-text-color has-text-xxl-font-size pt__5"><?php echo esc_html__('We help your business to stand out from the crowd', 'soloarone'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-m","paddingTop":3,"paddingRight":0} -->
<p class="has-font-secondary-color has-text-color has-text-m-font-size pt__3"><?php echo esc_html__('We create everything from web design to mobile applications, social media management and more. We focus on your target market and what will sell.', 'soloarone'); ?></p>
<!-- /wp:paragraph -->
